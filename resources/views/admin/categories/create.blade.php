...
@section('page_subtitle', 'Isi form di bawah untuk menambah kategori event.')
...
<div class="p-6 max-w-2xl mx-auto">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">Isi form di bawah untuk menambah kategori event.</p>
        </div>
    </div>
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST">
            ...
            <div class="mb-8">
                <label for="slug" class="block text-sm font-semibold text-gray-700 mb-1.5">
                    Slug <span class="text-gray-400 font-normal text-xs">(kosongkan untuk generate otomatis)</span>
                </label>
                ...
                @error('slug')
                    <p class="mt-1.5 text-xs text-red-500">{{ $message }}</p>
                @enderror
                <p class="mt-1.5 text-xs text-gray-400">Slug digunakan sebagai URL. Hanya huruf kecil, angka, dan tanda hubung.</p>
            </div>
